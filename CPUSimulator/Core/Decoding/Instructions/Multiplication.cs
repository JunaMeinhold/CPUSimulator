namespace CPUSimulator.Core.Decoding.Instructions
{
    ...
    {
        public static void MUL(ParseBlock block)
        {
            MicrocodeBuilder builder = new MicrocodeBuilder().SetNextAddress(block.NextAddress).SetALUFunction(ALUFunction.Multiplication);
