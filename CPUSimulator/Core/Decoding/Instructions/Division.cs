namespace CPUSimulator.Core.Decoding.Instructions
{
    ...
    {
        public static void DIV(ParseBlock block)
        {
            MicrocodeBuilder builder = new MicrocodeBuilder().SetNextAddress(block.NextAddress).SetALUFunction(ALUFunction.Division);
