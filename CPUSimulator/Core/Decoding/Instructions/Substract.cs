namespace CPUSimulator.Core.Decoding.Instructions
{
    ...
    {
        public static void SUB(ParseBlock block)
        {
            MicrocodeBuilder builder = new MicrocodeBuilder().SetNextAddress(block.NextAddress).SetALUFunction(ALUFunction.Substraction);
