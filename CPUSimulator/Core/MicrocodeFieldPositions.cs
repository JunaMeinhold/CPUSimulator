namespace CPUSimulator.Core
{
    ...
    {
        // 49 Bit
        // MC  MCNext CC ALU-FC X-Bus    Y-Bus    Z-Bus    IO-RAM Mode RAM-Bus-Width
        // 000 000000 0  000000 00000000 00000000 00000000 000000 00   00

        public const int MC_SHIFT = 46;
        public const int MC_BITS = 3;
        public const ulong MC_MASK = (1UL << MC_BITS) - 1; // 0b111 (3 bits)

        public const int MCNEXT_SHIFT = 41;
        public const int MCNEXT_BITS = 5;
        public const ulong MCNEXT_MASK = (1UL << MCNEXT_BITS) - 1; // 0b11111 (5 bits)

        public const int CC_SHIFT = 40;
